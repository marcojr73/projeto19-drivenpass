/*
  ...
  - A unique constraint covering the columns `[title,userId]` on the table `security_notes` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "security_notes_title_userId_key" ON "security_notes"("title", "userId");
